...
local keyboard = {
{'تعطيل التواصل ✖️','ضع كليشه ستارت 💬'},
{' ضع اسم للبوت',' المطورين 🕹️','اذاعه'},
{'اذاعه بالتوجيه 🔖','قائمه العام 📜','اذاعه بالتوجيه خاص 👤'},
{'الاحصائيات🔍 '},
{'اذاعه خاص 👤','تفعيل البوت الخدمي','تعطيل البوت الخدمي','جلب نسخه احتياطيه 📂'},
{'تحديث السورس ™'},
...
usertext = '\n👤¦ العضو » ['..result.title_..'](t.me/'..(username or 'DEVBOYKA')..')'
...
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBOYKA')..')'
status  = '\n📫¦ تم ترقيته مطور في البوت'
...
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/DEVBOYKA)}\n📛¦["..BOYKA_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DEVBOYKA')..') \n🔐¦ تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DEVBOYKA')..') \n🔐¦ تـم قفـل التاك بالكتم ')  
end,nil)   
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤¦ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'DEVBOYKA')..')'..'\n📬¦ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
